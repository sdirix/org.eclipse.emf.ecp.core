...
public abstract class ModelelementSelectionDialog extends FilteredItemsSelectionDialog
{
   ...
   */
  public ModelelementSelectionDialog(Collection<EObject> modelElements)
  {
    this(modelElements, false);
  }
   ...
   *          indicates whether dialog allows to select more than one item
   */
  public ModelelementSelectionDialog(Collection<EObject> modelElements, boolean multiSelection)
  {
   ...
   */
  public ModelelementSelectionDialog(Collection<EObject> modelElements, EClass classType)
  {
    this(modelElements, classType, false);
  }
