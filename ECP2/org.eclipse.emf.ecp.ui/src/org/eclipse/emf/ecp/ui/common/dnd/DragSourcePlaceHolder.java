 ...
 * a class to keep track of dragSource. Instead, one should use a transfer class. This is not the case because of the
 * following:
 * 
 * <ol>
 * <li>Using a transfer is not guaranteed to work on all platforms and always.</li>
 * <li>On platforms other than Windows, dragSource is not set until drop event fires and we need dragSource during
 * events like dragOver</li>
