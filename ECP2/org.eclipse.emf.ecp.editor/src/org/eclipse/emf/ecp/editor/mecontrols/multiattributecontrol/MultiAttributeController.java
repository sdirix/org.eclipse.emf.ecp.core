...
public class MultiAttributeController<T> implements IChangeListener
{
   ...
   * 
   * @param parentItem
   *          the corresponding MultiAttributeWidget
   * @param data
   *          a reference to the data manipulated by this controller
   */
  MultiAttributeController(MultiAttributeControl parentItem, InternalEList<T> data)
  {
