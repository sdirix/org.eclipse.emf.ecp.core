...
import org.eclipse.emf.ecp.editor.MEClassLabelProvider;
...
public class NewReferenceAction extends ReferenceAction {
	...
	public void run() {
		if (eReference.isContainer()) {
			MessageDialog.openError(PlatformUI.getWorkbench().getActiveWorkbenchWindow().getShell(), "", "Operation not permitted for container references!");
			return;
		}
