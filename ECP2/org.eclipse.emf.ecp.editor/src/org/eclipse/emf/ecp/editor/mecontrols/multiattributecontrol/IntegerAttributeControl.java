 ...
 */
class IntegerAttributeControl extends AttributeControl<Integer, Spinner>
{
   ...
   * 
   * @param parentItem
   *          the corresponding IntegerMultiAttributeWidget
  ...
  {
    super(dataManipulator, IntegerMultiAttributeControl.getEmptyValue());
