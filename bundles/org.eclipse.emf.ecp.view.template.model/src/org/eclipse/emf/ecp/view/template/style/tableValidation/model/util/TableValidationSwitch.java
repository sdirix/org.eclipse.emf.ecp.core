...
public class TableValidationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VTTableValidationPackage.TABLE_VALIDATION_STYLE_PROPERTY: {
			final VTTableValidationStyleProperty tableValidationStyleProperty = (VTTableValidationStyleProperty) theEObject;
			T result = caseTableValidationStyleProperty(tableValidationStyleProperty);
			if (result == null) {
				result = caseStyleProperty(tableValidationStyleProperty);
			}
			if (result == null) {
