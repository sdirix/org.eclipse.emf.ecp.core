...
public class TableValidationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VTTableValidationPackage.TABLE_VALIDATION_STYLE_PROPERTY: {
				VTTableValidationStyleProperty tableValidationStyleProperty = (VTTableValidationStyleProperty)theEObject;
				T result = caseTableValidationStyleProperty(tableValidationStyleProperty);
				if (result == null) result = caseStyleProperty(tableValidationStyleProperty);
	 ...
	 * @generated
	 */
	public T caseTableValidationStyleProperty(VTTableValidationStyleProperty object) {
		return null;
	}
