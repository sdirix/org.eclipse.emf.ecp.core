...
public class FontPropertiesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VTFontPropertiesPackage.FONT_PROPERTIES_STYLE_PROPERTY: {
			final VTFontPropertiesStyleProperty fontPropertiesStyleProperty = (VTFontPropertiesStyleProperty) theEObject;
			T result = caseFontPropertiesStyleProperty(fontPropertiesStyleProperty);
			if (result == null) {
				result = caseStyleProperty(fontPropertiesStyleProperty);
			}
			if (result == null) {
