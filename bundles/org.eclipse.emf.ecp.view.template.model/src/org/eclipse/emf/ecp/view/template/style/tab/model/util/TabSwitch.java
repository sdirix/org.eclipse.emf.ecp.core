 ...
 */
package org.eclipse.emf.ecp.view.template.style.tab.model.util;
...
public class TabSwitch<T> extends Switch<T> {
	 ...
	 * @generated
	 */
	protected static VTTabPackage modelPackage;
	...
	public TabSwitch() {
		if (modelPackage == null) {
			modelPackage = VTTabPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VTTabPackage.TAB_STYLE_PROPERTY: {
			final VTTabStyleProperty tabStyleProperty = (VTTabStyleProperty) theEObject;
			T result = caseTabStyleProperty(tabStyleProperty);
			if (result == null) {
				result = caseStyleProperty(tabStyleProperty);
			}
			if (result == null) {
	 ...
	 * @generated
	 */
	public T caseTabStyleProperty(VTTabStyleProperty object) {
		return null;
	}
