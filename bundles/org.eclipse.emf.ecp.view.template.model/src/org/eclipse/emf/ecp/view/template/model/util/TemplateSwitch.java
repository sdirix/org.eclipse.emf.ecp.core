...
public class TemplateSwitch<T> extends Switch<T>
{
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		...
		case VTTemplatePackage.CONTROL_VALIDATION_TEMPLATE: {
			final VTControlValidationTemplate controlValidationTemplate = (VTControlValidationTemplate) theEObject;
			T result = caseControlValidationTemplate(controlValidationTemplate);
			if (result == null) {
				result = defaultCase(theEObject);
			}
			return result;
		...
		case VTTemplatePackage.STYLE_PROPERTY: {
			final VTStyleProperty styleProperty = (VTStyleProperty) theEObject;
			T result = caseStyleProperty(styleProperty);
			if (result == null) {
				result = defaultCase(theEObject);
			}
			return result;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>View Template</em>'.
	 * <!-- begin-user-doc -->
	 ...
	 * @return the result of interpreting the object as an instance of '<em>View Template</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Control Validation Template</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Control Validation Template</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
