 ...
 */
package org.eclipse.emf.ecp.view.template.style.textControlEnablement.model.util;
 ...
 * @generated
 */
public class TextControlEnablementSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public TextControlEnablementSwitch() {
		if (modelPackage == null) {
			modelPackage = VTTextControlEnablementPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VTTextControlEnablementPackage.TEXT_CONTROL_ENABLEMENT_STYLE_PROPERTY: {
				VTTextControlEnablementStyleProperty textControlEnablementStyleProperty = (VTTextControlEnablementStyleProperty)theEObject;
				T result = caseTextControlEnablementStyleProperty(textControlEnablementStyleProperty);
				if (result == null) result = caseStyleProperty(textControlEnablementStyleProperty);
	 ...
	 * @generated
	 */
	public T caseTextControlEnablementStyleProperty(VTTextControlEnablementStyleProperty object) {
		return null;
	}
