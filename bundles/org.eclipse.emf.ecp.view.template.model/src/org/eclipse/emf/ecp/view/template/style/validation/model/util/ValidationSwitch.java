...
public class ValidationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VTValidationPackage.VALIDATION_STYLE_PROPERTY: {
			final VTValidationStyleProperty validationStyleProperty = (VTValidationStyleProperty) theEObject;
			T result = caseValidationStyleProperty(validationStyleProperty);
			if (result == null) {
				result = caseStyleProperty(validationStyleProperty);
			}
			if (result == null) {
	 ...
	 * @generated
	 */
	public T caseValidationStyleProperty(VTValidationStyleProperty object) {
		return null;
	}
