...
public class VTFontPropertiesPackageImpl extends EPackageImpl implements VTFontPropertiesPackage {
	...
	public static VTFontPropertiesPackage init() {
		if (isInited) return (VTFontPropertiesPackage)EPackage.Registry.INSTANCE.getEPackage(VTFontPropertiesPackage.eNS_URI);

		// Obtain or create and register package
		VTFontPropertiesPackageImpl theFontPropertiesPackage = (VTFontPropertiesPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof VTFontPropertiesPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new VTFontPropertiesPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEClass(fontPropertiesStylePropertyEClass, VTFontPropertiesStyleProperty.class, "FontPropertiesStyleProperty", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(getFontPropertiesStyleProperty_Italic(), ecorePackage.getEBoolean(), "italic", null, 0, 1, VTFontPropertiesStyleProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getFontPropertiesStyleProperty_Bold(), ecorePackage.getEBoolean(), "bold", null, 0, 1, VTFontPropertiesStyleProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getFontPropertiesStyleProperty_ColorHEX(), ecorePackage.getEString(), "colorHEX", null, 0, 1, VTFontPropertiesStyleProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getFontPropertiesStyleProperty_Height(), ecorePackage.getEInt(), "height", null, 0, 1, VTFontPropertiesStyleProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(getFontPropertiesStyleProperty_FontName(), ecorePackage.getEString(), "fontName", null, 0, 1, VTFontPropertiesStyleProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
