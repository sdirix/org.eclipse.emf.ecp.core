 ...
 * @generated
 */
public class UnsettableSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VTUnsettablePackage.UNSETTABLE_STYLE_PROPERTY: {
			final VTUnsettableStyleProperty unsettableStyleProperty = (VTUnsettableStyleProperty) theEObject;
			T result = caseUnsettableStyleProperty(unsettableStyleProperty);
			if (result == null) {
				result = caseStyleProperty(unsettableStyleProperty);
			}
			if (result == null) {
	 ...
	 * @generated
	 */
	public T caseUnsettableStyleProperty(VTUnsettableStyleProperty object) {
		return null;
	}
