...
public class AlignmentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VTAlignmentPackage.ALIGNMENT_STYLE_PROPERTY: {
			final VTAlignmentStyleProperty alignmentStyleProperty = (VTAlignmentStyleProperty) theEObject;
			T result = caseAlignmentStyleProperty(alignmentStyleProperty);
			if (result == null) {
				result = caseStyleProperty(alignmentStyleProperty);
			}
			if (result == null) {
