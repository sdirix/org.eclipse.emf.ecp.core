 ...
 */
package org.eclipse.emf.ecp.view.template.selector.domainmodelreference.model.util;
...
public class DomainmodelreferenceSwitch<T> extends Switch<T>
{
	 ...
	 * @generated
	 */
	protected static VTDomainmodelreferencePackage modelPackage;
	...
	protected T doSwitch(int classifierID, EObject theEObject)
	{
		...
		case VTDomainmodelreferencePackage.DOMAIN_MODEL_REFERENCE_SELECTOR: {
			...
			if (result == null) {
				result = caseStyleSelector(domainModelReferenceSelector);
			}
			if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Domain Model Reference Selector</em>'.
	 * <!-- begin-user-doc -->
	 ...
	 * @return the result of interpreting the object as an instance of '<em>Domain Model Reference Selector</em>'.
