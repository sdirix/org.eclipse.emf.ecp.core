...
public class MultisegmentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VMultisegmentPackage.MULTI_DOMAIN_MODEL_REFERENCE_SEGMENT: {
			final VMultiDomainModelReferenceSegment multiDomainModelReferenceSegment = (VMultiDomainModelReferenceSegment) theEObject;
			T result = caseMultiDomainModelReferenceSegment(multiDomainModelReferenceSegment);
			if (result == null) {
				result = caseFeatureDomainModelReferenceSegment(multiDomainModelReferenceSegment);
			}
			if (result == null) {
				result = caseDomainModelReferenceSegment(multiDomainModelReferenceSegment);
			}
			if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Multi Domain Model Reference Segment</em>'.
	 * <!-- begin-user-doc -->
	 ...
	 * @return the result of interpreting the object as an instance of '<em>Multi Domain Model Reference Segment</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMultiDomainModelReferenceSegment(VMultiDomainModelReferenceSegment object) {
		return null;
	}
