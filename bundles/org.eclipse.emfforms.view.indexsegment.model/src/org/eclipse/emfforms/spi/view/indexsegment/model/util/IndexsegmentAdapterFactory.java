...
public class IndexsegmentAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected IndexsegmentSwitch<Adapter> modelSwitch = new IndexsegmentSwitch<Adapter>() {
		@Override
	 ...
	 * <em>Index Domain Model Reference Segment</em>}'. <!-- begin-user-doc --> This
	...
	/**
	 * Creates a new adapter for an object of class
	 * '{@link org.eclipse.emf.ecp.view.spi.model.VDomainModelReferenceSegment
	 * <em>Domain Model Reference Segment</em>}'. <!-- begin-user-doc --> This
	 * default implementation returns null so that we can easily ignore cases; it's
	 * useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 *
	 ...
	 * <em>Feature Domain Model Reference Segment</em>}'. <!-- begin-user-doc -->
