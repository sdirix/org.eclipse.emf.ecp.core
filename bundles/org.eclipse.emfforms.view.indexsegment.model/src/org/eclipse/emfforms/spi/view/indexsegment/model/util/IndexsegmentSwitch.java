 ...
 *
 * @see org.eclipse.emfforms.spi.view.indexsegment.model.VIndexsegmentPackage
 * @generated
 */
public class IndexsegmentSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VIndexsegmentPackage.INDEX_DOMAIN_MODEL_REFERENCE_SEGMENT: {
			...
			if (result == null) {
				result = caseFeatureDomainModelReferenceSegment(indexDomainModelReferenceSegment);
			}
			if (result == null) {
				result = caseDomainModelReferenceSegment(indexDomainModelReferenceSegment);
			}
			if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Index
	 * Domain Model Reference Segment</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the
	 * switch. <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Index
	 *         Domain Model Reference Segment</em>'.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Domain
	 * Model Reference Segment</em>'. <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Domain
