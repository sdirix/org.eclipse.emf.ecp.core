 ...
 * <!-- end-user-doc -->
 *
 * @see org.eclipse.emfforms.spi.rulerepository.model.VRulerepositoryPackage#getMergeType()
 * @model
 * @generated
 */
public enum MergeType implements Enumerator {
	 ...
	 * @generated
	 */
	private static final MergeType[] VALUES_ARRAY = new MergeType[] {
		AND,
		OR,
	};
	...
	public static MergeType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			final MergeType result = VALUES_ARRAY[i];
