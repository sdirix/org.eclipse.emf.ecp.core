...
/**
 * DI renderer service for {@link MultiSegmentChildDmrsSWTRenderer}.
 *
 * @author Lucas Koehler
 *
 */
@Component(name = "MultiSegmentChildDmrsSWTRendererService")
public class MultiSegmentChildDmrsSWTRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (VViewPackage.Literals.CONTROL__DOMAIN_MODEL_REFERENCE != feature) {
			return NOT_APPLICABLE;
		}
		return 10d;
	}
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return MultiSegmentChildDmrsSWTRenderer.class;
	}
