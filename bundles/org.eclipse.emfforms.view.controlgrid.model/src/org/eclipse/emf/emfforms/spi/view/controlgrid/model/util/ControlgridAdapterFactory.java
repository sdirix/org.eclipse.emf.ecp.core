...
public class ControlgridAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected ControlgridSwitch<Adapter> modelSwitch = new ControlgridSwitch<Adapter>() {
		@Override
		public Adapter caseControlGrid(VControlGrid object) {
			return createControlGridAdapter();
		}

		@Override
		public Adapter caseControlGridRow(VControlGridRow object) {
			return createControlGridRowAdapter();
		}

		@Override
		public Adapter caseControlGridCell(VControlGridCell object) {
			return createControlGridCellAdapter();
		}
	 ...
	 * {@link org.eclipse.emf.emfforms.spi.view.controlgrid.model.VControlGrid <em>Control Grid</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.emf.emfforms.spi.view.controlgrid.model.VControlGridRow <em>Control Grid Row</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.eclipse.emf.emfforms.spi.view.controlgrid.model.VControlGridCell <em>Control Grid Cell</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
