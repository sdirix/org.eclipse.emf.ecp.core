...
/**
 * This label provider wraps an AdapterFactory and it delegates its JFace provider interfaces to
 * corresponding adapter-implemented item provider interfaces. All method calls to the various label
 * provider interfaces are delegated to interfaces implemented by the adapters generated by the
 * AdapterFactory. {@link ILabelProvider} is delegated to {@link IItemLabelProvider}; {@link IFontProvider} is delegated
 * to {@link IItemFontProvider}; {@link IColorProvider} is
 * delegated to {@link IItemColorProvider}; {@link ITableLabelProvider} is delegated to {@link ITableItemLabelProvider};
 * and {@link ITableFontProvider} is delegated to {@link ITableItemFontProvider}. and {@link ITableColorProvider} is
...
public class AdapterFactoryLabelProvider implements ILabelProvider, ITableLabelProvider,
	 ...
	 */
	public static class FontProvider extends AdapterFactoryLabelProvider implements IFontProvider,
		ITableFontProvider {
		/**
		 * Construct an instance that wraps the given factory and specifies the given default font.
		 * 
		 * @param adapterFactory
		 *            an adapter factory that yield adapters that implement the various item label
		 *            provider interfaces.
		 * @param defaultFont
		...
		/**
		 * Construct an instance that wraps the given factory and uses the font of the viewer's
		 * control.
		 * 
		 * @param adapterFactory
		 *            an adapter factory that yield adapters that implement the various item label
	 ...
	 */
	public static class ColorProvider extends AdapterFactoryLabelProvider implements
		IColorProvider, ITableColorProvider {
		/**
		 * Construct an instance that wraps the given factory and specifies the given default
		 * colors.
		 * 
		 * @param adapterFactory
		 *            an adapter factory that yield adapters that implement the various item label
		 ...
		 */
		public ColorProvider(AdapterFactory adapterFactory, Color defaultForeground,
		...
		/**
		 * Construct an instance that wraps the given factory and uses the colors of the viewer's
		 * control.
		 * 
		 * @param adapterFactory
		 *            an adapter factory that yield adapters that implement the various item label
		...
		public ColorProvider(AdapterFactory adapterFactory, Viewer viewer) {
			this(adapterFactory, viewer.getControl().getForeground(), viewer.getControl()
				.getBackground());
		}
	}

	/**
	 * An extended version of the adapter factory label provider that also provides for fonts and
	 * colors.
	 */
	public static class FontAndColorProvider extends AdapterFactoryLabelProvider implements
		 ...
		 *            the background color that will be used when no background color is specified.
		 */
		public FontAndColorProvider(AdapterFactory adapterFactory, Font defaultFont,
		...
		/**
		 * Construct an instance that wraps the given factory and uses the font and colors of the
		 * viewer's control.
		 * 
		 * @param adapterFactory
		 *            an adapter factory that yield adapters that implement the various item label
		...
		public FontAndColorProvider(AdapterFactory adapterFactory, Viewer viewer) {
			this(adapterFactory, viewer.getControl().getFont(),
				viewer.getControl().getForeground(), viewer.getControl().getBackground());
		}
	}
	...
	/**
	 * Construct an instance that wraps the given factory. If the adapter factory is an {@link IChangeNotifier}, a
	...
	/**
	 * Set the wrapped AdapterFactory. If the adapter factory is an {@link IChangeNotifier}, a
	 * listener is added to it, so it's important to call {@link #dispose()}.
	 */
	...
	public String getText(Object object) {
		...
		return itemLabelProvider != null ? itemLabelProvider.getText(object) : object == null ? ""
			: object.toString();
	}
	...
	public Font getFont(Object object) {
		...
		return itemFontProvider != null ? getFontFromObject(itemFontProvider.getFont(object))
			: null;
	}
	...
	protected Color getColorFromObject(Object object) {
		return object == null ? null : ExtendedColorRegistry.INSTANCE.getColor(defaultForeground,
			defaultBackground, object);
	}

	/**
	 * This implements {@link ITableLabelProvider}.getColumnImage by forwarding it to an object that
	 * implements {@link ITableItemLabelProvider#getColumnImage
	 * ITableItemLabelProvider.getColumnImage} or failing that, an object that implements
	 * {@link IItemLabelProvider#getImage IItemLabelProvider.getImage} where the columnIndex is
	 * ignored.
	 */
	public Image getColumnImage(Object object, int columnIndex) {
		// Get the adapter from the factory.
		//
		final ITableItemLabelProvider tableItemLabelProvider = (ITableItemLabelProvider) adapterFactory
		...
		//
			...
			final IItemLabelProvider itemLabelProvider = (IItemLabelProvider) adapterFactory.adapt(
				object, IItemLabelProviderClass);
	...
	/**
	 * This implements {@link ITableLabelProvider}.getColumnText by forwarding it to an object that
	 * implements {@link ITableItemLabelProvider#getColumnText
	 * ITableItemLabelProvider.getColumnText} or failing that, an object that implements
	 * {@link IItemLabelProvider#getText IItemLabelProvider.getText} where the columnIndex are is
	 * ignored.
	 */
	...
	/**
	 * This implements {@link ITableFontProvider}.getFont by forwarding it to an object that
	 * implements {@link ITableItemFontProvider#getFont ITableItemFontProvider.getFont} or failing
	 * that, an object that implements {@link IItemFontProvider#getFont IItemFontProvider.getFont} where the columnIndex
	 * is ignored.
	 */
	public Font getFont(Object object, int columnIndex) {
		// Get the adapter from the factory.
		//
		final ITableItemFontProvider tableItemFontProvider = (ITableItemFontProvider) adapterFactory
	...
	/**
	 * This implements {@link ITableColorProvider}.getForeground by forwarding it to an object that
	 * implements {@link ITableItemColorProvider#getForeground
	 * ITableItemColorProvider.getForeground} or failing that, an object that implements
	 * {@link IItemColorProvider#getForeground IItemColorProvider.getForeground} where the
	 * columnIndex is ignored.
	 */
	public Color getForeground(Object object, int columnIndex) {
		// Get the adapter from the factory.
		//
		final ITableItemColorProvider tableItemColorProvider = (ITableItemColorProvider) adapterFactory
		...
		//
			...
			final IItemColorProvider itemColorProvider = (IItemColorProvider) adapterFactory.adapt(
				object, IItemColorProviderClass);
	...
	/**
	 * This implements {@link ITableColorProvider}.getBackground by forwarding it to an object that
	 * implements {@link ITableItemColorProvider#getBackground
	 * ITableItemColorProvider.getBackground} or failing that, an object that implements
	 * {@link IItemColorProvider#getBackground IItemColorProvider.getBackground} where the
	 * columnIndex is ignored.
	 */
	 ...
	 * {@link ILabelProviderListener#labelProviderChanged(LabelProviderChangedEvent) update
	 * notifications}.
	 */
