 ...
 * AdapterFactory. {@link ILabelProvider} is delegated to {@link IItemLabelProvider};
 * {@link IFontProvider} is delegated to {@link IItemFontProvider}; {@link IColorProvider} is
 * delegated to {@link IItemColorProvider}; {@link ITableLabelProvider} is delegated to
 * {@link ITableItemLabelProvider}; and {@link ITableFontProvider} is delegated to
 * {@link ITableItemFontProvider}. and {@link ITableColorProvider} is delegated to
 * {@link ITableItemColorProvider}.
 * <p>
 * The label provider has no mechanism for notifying the viewer of changes. As long as the
 * AdapterFactory is also used in an AdapterFactoryContentProvider, this won't be a problem, because
 * notifications will be forward as a result of that.
 */
public class AdapterFactoryLabelProvider implements ILabelProvider, ITableLabelProvider,
    ...
    /**
     * Construct an instance that wraps the given factory. If the adapter factory is an
     * {@link IChangeNotifier}, a listener is added to it, so it's important to call
     * {@link #dispose()}.
     * 
     * @param adapterFactory
     *            an adapter factory that yield adapters that implement the various item label
     ...
     * that, an object that implements {@link IItemFontProvider#getFont IItemFontProvider.getFont}
    ...
    public Color getForeground(Object object, int columnIndex) {
        ...
        //
            ...
            IItemColorProvider itemColorProvider = (IItemColorProvider) adapterFactory.adapt(
