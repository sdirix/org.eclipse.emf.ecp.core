...
public class NotifyChangedToViewerRefresh {
	public static void handleNotifyChanged(final Viewer viewer, final Object object,
		...
		if (d != Display.getCurrent()) {
			d.asyncExec(new Runnable() {
				public void run() {
					if (viewer.getControl() != null && !viewer.getControl().isDisposed()) {
						new NotifyChangedToViewerRefresh().refresh(viewer, object, eventType,
							feature, oldValue, newValue, index);
					}
				}
			});
		} else {
			new NotifyChangedToViewerRefresh().refresh(viewer, object, eventType, feature,
				oldValue, newValue, index);
		}
	}

	public void refresh(Viewer viewer, Object object, int eventType, Object feature,
		Object oldValue, Object newValue, int index) {
		if (viewer instanceof TreeViewer) {
			refreshTreeViewer((TreeViewer) viewer, object, eventType, feature, oldValue, newValue,
				index);
		} else if (viewer instanceof TableViewer) {
			refreshTableViewer((TableViewer) viewer, object, eventType, feature, oldValue,
				newValue, index);
		} else if (viewer instanceof ListViewer) {
			refreshListViewer((ListViewer) viewer, object, eventType, feature, oldValue, newValue,
				index);
		} else {
	...
	public void refreshTreeViewer(TreeViewer viewer, Object object, int eventType, Object feature,
		Object oldValue, Object newValue, int index) {
		switch (eventType) {
	...
	public void refreshListViewer(ListViewer viewer, Object object, int eventType, Object feature,
		Object oldValue, Object newValue, int index) {
		switch (eventType) {
		case Notification.ADD: {
			viewer.add(newValue);
	...
	public void refreshTableViewer(TableViewer viewer, Object object, int eventType,
	...
	public void refreshAbstractTreeViewer(AbstractTreeViewer viewer, Object object, int eventType,
		Object feature, Object oldValue, Object newValue, int index) {
		switch (eventType) {
		case Notification.ADD: {
			if (newValue == null) {
	...
	public void refreshStructuredViewer(StructuredViewer viewer, Object object, int eventType,
		...
		case Notification.SET: {
			if (feature instanceof EReference) {
				...
				viewer.update(
					object,
					feature instanceof ENamedElement ? new String[] { ((ENamedElement) feature)
						.getName() } : null);
			}
			break;
		}
