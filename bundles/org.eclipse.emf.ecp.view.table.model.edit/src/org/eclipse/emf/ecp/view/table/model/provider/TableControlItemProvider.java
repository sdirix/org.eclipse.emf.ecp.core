...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.ecp.view.table.model.TableControl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class TableControlItemProvider
	...
	protected void addAddRemoveDisabledPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				...
				TablePackage.Literals.TABLE_CONTROL__ADD_REMOVE_DISABLED,
				true,
				false,
				false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TablePackage.Literals.TABLE_CONTROL__COLUMNS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		case TablePackage.TABLE_CONTROL__ADD_REMOVE_DISABLED:
			fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
			return;
		case TablePackage.TABLE_CONTROL__COLUMNS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			...
			(TablePackage.Literals.TABLE_CONTROL__COLUMNS,
				TableFactory.eINSTANCE.createTableColumn()));
	}
