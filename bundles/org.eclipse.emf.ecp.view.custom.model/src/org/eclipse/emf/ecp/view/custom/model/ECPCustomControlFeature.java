...
public final class ECPCustomControlFeature {
	 ...
	 * @param targetToModel update strategy target to model, can be null
	 * @param modelToTarget update strategy model to target, can be null
	...
	/**
	 * Gets an {@link IObservableList} for the {@link EObject} and {@link EStructuralFeature} of this
	 * {@link ECPCustomControlFeature}.
	 * 
	 * @return the {@link IObservableList} for this {@link ECPCustomControlFeature}
	 */
	public IObservableList getObservableList() {
		...
		if (!getTargetFeature().isMany()) {
			throw new IllegalArgumentException("This Feature is not a Multi-Feature.");
		}
		return EMFEditObservables.observeList(editingDomain,
			getRelevantEObject(), getTargetFeature());
	}
}