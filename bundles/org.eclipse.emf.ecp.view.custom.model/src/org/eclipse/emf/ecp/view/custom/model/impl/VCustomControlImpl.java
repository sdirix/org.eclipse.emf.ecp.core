 ...
 * <ul>
 * <li>{@link org.eclipse.emf.ecp.view.custom.model.impl.VCustomControlImpl#getBundle <em>Bundle</em>}</li>
 * <li>{@link org.eclipse.emf.ecp.view.custom.model.impl.VCustomControlImpl#getClassName <em>Class Name</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class VCustomControlImpl extends AbstractControlImpl implements VCustomControl {
	/**
	...
	public void setBundle(String newBundle) {
		...
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, VCustomPackage.CUSTOM_CONTROL__BUNDLE, oldBundle,
				bundle));
		}
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.ecp.view.custom.model.VCustomControl#getECPCustomControl()
	 */
