...
public class CustomDMRConverter implements DomainModelReferenceConverter {
	...
	public IValueProperty convertToValueProperty(VDomainModelReference domainModelReference)
		...
		return emfFormsDatabinding.getValueProperty(neededDomainModelReferences.iterator().next());
	}
	...
	public IListProperty convertToListProperty(VDomainModelReference domainModelReference)
		...
		return emfFormsDatabinding.getListProperty(neededDomainModelReferences.iterator().next());
	}
