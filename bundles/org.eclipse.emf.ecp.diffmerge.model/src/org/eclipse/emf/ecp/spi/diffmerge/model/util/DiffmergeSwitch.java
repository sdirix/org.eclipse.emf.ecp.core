 ...
 * 
 * @see org.eclipse.emf.ecp.spi.diffmerge.model.VDiffmergePackage
 * @generated
 */
public class DiffmergeSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VDiffmergePackage.DIFF_ATTACHMENT: {
			VDiffAttachment diffAttachment = (VDiffAttachment) theEObject;
			T result = caseDiffAttachment(diffAttachment);
			if (result == null)
				result = caseAttachment(diffAttachment);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Diff Attachment</em>'.
	 * <!-- begin-user-doc --> This implementation
	 * returns null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Diff Attachment</em>'.
