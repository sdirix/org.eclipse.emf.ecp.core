...
/**
 * DI renderer service for {@link LeafConditionControlRenderer}.
 *
 * @author Lucas Koehler
 *
 */
@Component(name = "LeafConditionControlRendererService")
public class LeafConditionControlRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return LeafConditionControlRenderer.class;
	}
