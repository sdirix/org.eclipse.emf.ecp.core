...
/**
 * DI renderer service for {@link RuleConditionDmrControlSWTRenderer}.
 *
 * @author Lucas Koehler
 *
 */
@Component(name = "RuleConditionDmrControlSWTRendererService")
public class RuleConditionDmrControlSWTRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		// Applicable for references defined by a Condition and pointing to a single DMR
		if (!(valueProperty.getValueType() instanceof EReference)) {
			return NOT_APPLICABLE;
		}
		final EReference reference = (EReference) valueProperty.getValueType();
		if (!reference.isMany()
			&& RulePackage.Literals.CONDITION.isSuperTypeOf(reference.getEContainingClass())
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return RuleConditionDmrControlSWTRenderer.class;
	}
