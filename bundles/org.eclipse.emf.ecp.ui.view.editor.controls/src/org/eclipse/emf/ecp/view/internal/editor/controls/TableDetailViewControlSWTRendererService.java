...
/**
 * DI renderer service for {@link TableDetailViewControlSWTRenderer}.
 *
 * @author Lucas Koehler
 *
 */
@Component(name = "TableDetailViewControlSWTRendererService")
public class TableDetailViewControlSWTRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return TableDetailViewControlSWTRenderer.class;
	}
