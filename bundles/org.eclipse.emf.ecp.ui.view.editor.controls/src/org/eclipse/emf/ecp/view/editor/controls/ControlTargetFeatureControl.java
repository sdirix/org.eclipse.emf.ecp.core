...
public class ControlTargetFeatureControl extends LinkControl {
    ...
    public ControlTargetFeatureControl(boolean showLabel,
    ...
    protected Button[] createButtons(Composite composite) {
        ...
        buttons[1] = createButtonForAction(
                new FilteredReferenceAction((EReference) getStructuralFeature(),
    ...
    private class FilteredReferenceAction extends AbstractFilteredReferenceAction {
        ...
        public FilteredReferenceAction(EReference eReference, IItemPropertyDescriptor descriptor,
                Shell shell) {
            ...
            getModelElementContext()
                    ...
                    .execute(
                            new FilteredReferenceCommand(
                                    ...
                                    composedAdapterFactory, shell));
        }
    }

    private class FilteredReferenceCommand extends
            AbstractFilteredReferenceCommand<EStructuralFeature> {

        public FilteredReferenceCommand(Notifier notifier,
                ComposedAdapterFactory composedAdapterFactory, Shell shell) {
            super(notifier, composedAdapterFactory, shell, Helper
                    .getRootEClass(getModelElementContext().getModelElement()),
                    new ISelectionStatusValidator() {

                        @Override
                        public IStatus validate(Object[] selection) {
                            if (selection.length != 0
                                    && EStructuralFeature.class.isInstance(selection[0])) {
        ...
        @Override
        protected void setSelectedValues(EStructuralFeature selectedFeature,
