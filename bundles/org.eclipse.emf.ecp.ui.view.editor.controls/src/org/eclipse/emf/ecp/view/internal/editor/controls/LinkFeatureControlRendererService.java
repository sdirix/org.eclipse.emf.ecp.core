...
/**
 * DI renderer service for {@link LinkFeatureControlRenderer}.
 *
 * @author Lucas Koehler
 *
 */
@Component(name = "LinkFeatureControlRendererService")
public class LinkFeatureControlRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return LinkFeatureControlRenderer.class;
	}
