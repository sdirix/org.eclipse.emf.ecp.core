...
/**
 *
 * DI renderer service for {@link ControlRootEClassControl2SWTRenderer}.
 *
 * @author Lucas Koehler
 *
 */
@Component(name = "ControlRootEClassControl2SWTRendererService")
public class ControlRootEClassControl2SWTRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return ControlRootEClassControl2SWTRenderer.class;
	}
