...
/**
 * DI renderer service for {@link StackItemControlRenderer}.
 *
 * @author Lucas Koehler
 *
 */
@Component(name = "StackItemControlRendererService")
public class StackItemControlRendererService implements EMFFormsDIRendererService<VControl> {
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return StackItemControlRenderer.class;
	}
