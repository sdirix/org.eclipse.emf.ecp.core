...
public class ControlRootEClassControl extends LinkControl {
    ...
    public ControlRootEClassControl(boolean showLabel,
            ...
            getModelElementContext()
                    ...
                    .execute(
                            new FilteredReferenceCommand(
                                    getModelElementContext().getModelElement(), shell));
        }
    }
    ...
    private class FilteredReferenceCommand extends ChangeCommand {
        ...
        protected void doExecute() {
            ...
            ElementTreeSelectionDialog dialog = new ElementTreeSelectionDialog(shell,
                    labelProvider, getContentProvider());
            ...
            if (Window.OK == result) {
                ...
                if (EClass.class.isInstance(selection)) {
                    ...
                    ((View) getModelElementContext().getModelElement())
                            .setRootEClass(selectedFeature);
                }
            }
