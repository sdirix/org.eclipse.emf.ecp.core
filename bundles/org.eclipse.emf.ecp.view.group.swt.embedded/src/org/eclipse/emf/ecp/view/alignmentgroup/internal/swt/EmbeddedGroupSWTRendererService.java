 ...
 *
 */
public class EmbeddedGroupSWTRendererService implements EMFFormsRendererService<VGroup> {
	...
	public AbstractSWTRenderer<VGroup> getRendererInstance(VGroup vElement, ViewModelContext viewModelContext) {
		return new EmbeddedGroupSWTRenderer(vElement, viewModelContext, reportService, rendererFactory);
	}
