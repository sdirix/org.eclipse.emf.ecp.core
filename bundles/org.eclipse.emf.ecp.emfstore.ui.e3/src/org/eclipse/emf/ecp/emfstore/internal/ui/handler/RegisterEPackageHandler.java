...
/**
 * This is the EMFStore Register EPackage Handler delegating to the {@link RegisterEPackageHelper}.
 * 
...
public class RegisterEPackageHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		RegisterEPackageHelper.registerEPackage(ecpRepository, HandlerUtil.getActiveShell(event));
		return null;
	}
