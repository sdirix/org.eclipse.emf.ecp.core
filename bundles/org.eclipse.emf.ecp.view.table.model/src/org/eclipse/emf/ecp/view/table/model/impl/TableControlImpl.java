 ...
 * <ul>
 * <li>{@link org.eclipse.emf.ecp.view.table.model.impl.TableControlImpl#getColumns <em>Columns</em>}</li>
 * <li>{@link org.eclipse.emf.ecp.view.table.model.impl.TableControlImpl#isAddRemoveDisabled <em>Add Remove Disabled
 * </em>}</li>
 * </ul>
 * </p>
 * 
...
public class TableControlImpl extends ControlImpl implements TableControl {
	...
	protected EClass eStaticClass() {
		return TablePackage.Literals.TABLE_CONTROL;
	}
	...
	public EList<TableColumn> getColumns() {
		if (columns == null) {
			columns = new EObjectContainmentEList<TableColumn>(TableColumn.class, this,
				TablePackage.TABLE_CONTROL__COLUMNS);
		}
		return columns;
	}
	...
	public void setAddRemoveDisabled(boolean newAddRemoveDisabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TablePackage.TABLE_CONTROL__ADD_REMOVE_DISABLED,
