...
public interface VTablePackage extends EPackage {
	 ...
	 * @see org.eclipse.emf.ecp.view.spi.table.model.VEnablementConfiguration#getColumnDomainModelReference()
	 * @see #getEnablementConfiguration()
	 * @generated
	 * @since 1.13
	 */
	EReference getEnablementConfiguration_ColumnDomainModelReference();
	...
	interface Literals {
		 ...
		 * @since 1.13
		 */
		EReference ENABLEMENT_CONFIGURATION__COLUMN_DOMAIN_MODEL_REFERENCE = eINSTANCE
