...
public class DataTemplatePackageImpl extends EPackageImpl implements DataTemplatePackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link DataTemplatePackage#eINSTANCE} when that field is accessed.
	...
	public static DataTemplatePackage init() {
		if (isInited) return (DataTemplatePackage)EPackage.Registry.INSTANCE.getEPackage(DataTemplatePackage.eNS_URI);

		// Obtain or create and register package
		DataTemplatePackageImpl theDataTemplatePackage = (DataTemplatePackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof DataTemplatePackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new DataTemplatePackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getTemplate_Instance(), theEcorePackage.getEObject(), null, "instance", null, 0, 1, Template.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(templateCollectionEClass, TemplateCollection.class, "TemplateCollection", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTemplateCollection_Templates(), this.getTemplate(), null, "templates", null, 0, -1, TemplateCollection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
