 ...
 *
 */
public class GroupSWTRendererService implements EMFFormsRendererService<VGroup> {
	...
	public AbstractSWTRenderer<VGroup> getRendererInstance(VGroup vElement, ViewModelContext viewModelContext) {
		return new GroupSWTRenderer(vElement, viewModelContext, reportService, rendererFactory, databindingService);
	}
