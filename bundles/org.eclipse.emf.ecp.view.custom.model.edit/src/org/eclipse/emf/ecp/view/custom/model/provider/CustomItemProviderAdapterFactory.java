 ...
 * @generated
 */
public class CustomItemProviderAdapterFactory extends CustomAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable, IChildCreationExtender {
	/**
	 ...
	 * @generated
	 */
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(CustomEditPlugin.INSTANCE, CustomPackage.eNS_URI);
	 ...
	 * @generated
	 */
	protected VPredefinedDomainModelReferenceItemProvider vPredefinedDomainModelReferenceItemProvider;
	...
	public Adapter createVPredefinedDomainModelReferenceAdapter() {
		if (vPredefinedDomainModelReferenceItemProvider == null) {
			vPredefinedDomainModelReferenceItemProvider = new VPredefinedDomainModelReferenceItemProvider(this);
		}

		return vPredefinedDomainModelReferenceItemProvider;
	}
	 ...
	 */
	public void dispose() {
		if (vPredefinedDomainModelReferenceItemProvider != null) vPredefinedDomainModelReferenceItemProvider.dispose();
	}
				...
				newChildDescriptors.add
					(createChildParameter
						(ViewPackage.Literals.CONTROL__DOMAIN_MODEL_REFERENCE,
						 CustomFactory.eINSTANCE.createVPredefinedDomainModelReference()));
