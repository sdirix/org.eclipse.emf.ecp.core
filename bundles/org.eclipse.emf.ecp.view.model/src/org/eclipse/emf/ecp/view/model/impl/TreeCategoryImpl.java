...
public class TreeCategoryImpl extends AbstractCategorizationImpl implements TreeCategory {
		...
		if (newChildComposite != childComposite)
		{
			...
			if (childComposite != null)
				msgs = ((InternalEObject) childComposite).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
					- ViewPackage.TREE_CATEGORY__CHILD_COMPOSITE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.TREE_CATEGORY__CHILD_COMPOSITE,
				newChildComposite, newChildComposite));
	}
	...
	public void setTargetFeature(EStructuralFeature newTargetFeature) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.TREE_CATEGORY__TARGET_FEATURE,
