...
public class CategoryImpl extends AbstractCategorizationImpl implements Category {
	...
	public NotificationChain basicSetComposite(Composite newComposite, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ViewPackage.CATEGORY__COMPOSITE, oldComposite, newComposite);
	...
	public void setComposite(Composite newComposite) {
		if (newComposite != composite) {
			...
			if (composite != null)
				msgs = ((InternalEObject)composite).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ViewPackage.CATEGORY__COMPOSITE, null, msgs);
			if (newComposite != null)
				msgs = ((InternalEObject)newComposite).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ViewPackage.CATEGORY__COMPOSITE, null, msgs);
			msgs = basicSetComposite(newComposite, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.CATEGORY__COMPOSITE, newComposite, newComposite));
	}
