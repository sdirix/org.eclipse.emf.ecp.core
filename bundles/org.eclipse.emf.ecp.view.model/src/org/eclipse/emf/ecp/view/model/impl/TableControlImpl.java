...
public class TableControlImpl extends ControlImpl implements TableControl {
	...
	public EList<TableColumn> getColumns() {
		if (columns == null) {
			columns = new EObjectContainmentEList<TableColumn>(TableColumn.class, this, ViewPackage.TABLE_CONTROL__COLUMNS);
		}
		return columns;
	}
	...
	public void setAddRemoveDisabled(boolean newAddRemoveDisabled) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ViewPackage.TABLE_CONTROL__ADD_REMOVE_DISABLED, oldAddRemoveDisabled, addRemoveDisabled));
	}
