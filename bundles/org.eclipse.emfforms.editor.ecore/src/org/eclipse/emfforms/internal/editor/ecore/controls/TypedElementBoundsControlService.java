 ...
 *
 */
public class TypedElementBoundsControlService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (eStructuralFeature.equals(EcorePackage.eINSTANCE.getETypedElement_UpperBound())
			|| eStructuralFeature.equals(EcorePackage.eINSTANCE.getETypedElement_LowerBound())) {
			return 10;
		}
		return NOT_APPLICABLE;
	}
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return TypedElementBoundsRenderer.class;
	}
