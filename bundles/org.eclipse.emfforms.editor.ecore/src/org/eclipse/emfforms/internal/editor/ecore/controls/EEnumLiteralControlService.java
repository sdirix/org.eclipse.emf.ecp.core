 ...
 *
 */
public class EEnumLiteralControlService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (eStructuralFeature.equals(EcorePackage.eINSTANCE.getEClassifier_DefaultValue())) {
			return 10;
		}
		return NOT_APPLICABLE;
	}
	...
	public Class<? extends AbstractSWTRenderer<VControl>> getRendererClass() {
		return EEnumLiteralRenderer.class;
	}
