 ...
 */
public class DataTypeControlService implements EMFFormsDIRendererService<VControl> {
	...
	public double isApplicable(VElement vElement, ViewModelContext viewModelContext) {
		...
		if (eStructuralFeature.equals(EcorePackage.eINSTANCE.getETypedElement_EType())) {
			return 10;
		}
		return NOT_APPLICABLE;
	}
