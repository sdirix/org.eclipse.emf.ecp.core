...
public interface VGroupPackage extends EPackage
{
	 ...
	 * @since 1.4
	 */
	int GROUP__GROUP_TYPE = VViewPackage.CONTAINER_FEATURE_COUNT + 0;
	 ...
	 * @since 1.4
	 */
	int GROUP__COLLAPSED = VViewPackage.CONTAINER_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int GROUP_FEATURE_COUNT = VViewPackage.CONTAINER_FEATURE_COUNT + 3;
