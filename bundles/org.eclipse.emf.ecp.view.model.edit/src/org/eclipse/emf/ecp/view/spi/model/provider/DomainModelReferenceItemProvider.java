...
public class DomainModelReferenceItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(VViewPackage.Literals.DOMAIN_MODEL_REFERENCE__SEGMENTS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VDomainModelReference.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(VViewPackage.Literals.DOMAIN_MODEL_REFERENCE__SEGMENTS,
			VViewFactory.eINSTANCE.createFeatureDomainModelReferenceSegment()));
	}
