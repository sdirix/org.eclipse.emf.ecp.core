...
public class FeatureDomainModelReferenceSegmentItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addDomainModelFeaturePropertyDescriptor(object);
		}
	...
	protected void addDomainModelFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_FeatureDomainModelReferenceSegment_domainModelFeature_feature"), //$NON-NLS-1$
				getString("_UI_PropertyDescriptor_description", //$NON-NLS-1$
					"_UI_FeatureDomainModelReferenceSegment_domainModelFeature_feature", //$NON-NLS-1$
					"_UI_FeatureDomainModelReferenceSegment_type"), //$NON-NLS-1$
				VViewPackage.Literals.FEATURE_DOMAIN_MODEL_REFERENCE_SEGMENT__DOMAIN_MODEL_FEATURE,
				true,
				false,
				false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FeatureDomainModelReferenceSegment")); //$NON-NLS-1$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VFeatureDomainModelReferenceSegment.class)) {
