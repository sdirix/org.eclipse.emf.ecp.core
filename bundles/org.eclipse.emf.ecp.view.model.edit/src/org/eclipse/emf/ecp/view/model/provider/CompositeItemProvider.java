...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.ecp.view.model.Composite} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
...
public class CompositeItemProvider
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				...
				ViewPackage.Literals.COMPOSITE__NAME,
				true,
				false,
				false,
	...
	public String getText(Object object) {
		final String label = ((Composite) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_Composite_type") : label;
	}
