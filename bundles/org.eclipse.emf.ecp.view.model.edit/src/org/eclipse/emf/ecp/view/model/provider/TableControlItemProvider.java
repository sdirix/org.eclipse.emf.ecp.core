...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.ecp.view.model.TableControl} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableControlItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TableControl_addRemoveDisabled_feature", "_UI_TableControl_type"),
				 ViewPackage.Literals.TABLE_CONTROL__ADD_REMOVE_DISABLED,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ViewPackage.Literals.TABLE_CONTROL__COLUMNS);
		}
	...
	public String getText(Object object) {
		String label = ((TableControl)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(TableControl.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ViewPackage.Literals.TABLE_CONTROL__COLUMNS,
				 ViewFactory.eINSTANCE.createTableColumn()));
	}
