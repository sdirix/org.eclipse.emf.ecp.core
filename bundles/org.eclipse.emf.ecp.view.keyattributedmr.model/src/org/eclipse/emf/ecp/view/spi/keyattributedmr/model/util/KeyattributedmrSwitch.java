...
public class KeyattributedmrSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case VKeyattributedmrPackage.KEY_ATTRIBUTE_DOMAIN_MODEL_REFERENCE: {
			...
			if (result == null) {
				result = caseFeaturePathDomainModelReference(keyAttributeDomainModelReference);
			}
			if (result == null) {
				result = caseDomainModelReference(keyAttributeDomainModelReference);
			}
			if (result == null) {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Key Attribute Domain Model Reference</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will
	 * terminate the switch. <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Key Attribute Domain Model Reference</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseKeyAttributeDomainModelReference(
		VKeyAttributeDomainModelReference object) {
		return null;
	}
