...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.ecp.view.template.style.tableValidation.model.VTTableValidationStyleProperty} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableValidationStylePropertyItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TableValidationStyleProperty_columnWidth_feature", "_UI_TableValidationStyleProperty_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TableValidationStyleProperty_columnName_feature", "_UI_TableValidationStyleProperty_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TableValidationStyleProperty_imagePath_feature", "_UI_TableValidationStyleProperty_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	public String getText(Object object) {
		String label = ((VTTableValidationStyleProperty)object).getColumnName();
	...
	public ResourceLocator getResourceLocator() {
		return TableValidationColumnStylePropertyEditPlugin.INSTANCE;
	}
