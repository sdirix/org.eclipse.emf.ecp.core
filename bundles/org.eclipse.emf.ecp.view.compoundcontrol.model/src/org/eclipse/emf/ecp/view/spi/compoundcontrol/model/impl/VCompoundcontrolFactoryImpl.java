...
public class VCompoundcontrolFactoryImpl extends EFactoryImpl implements VCompoundcontrolFactory
{
	...
	public static VCompoundcontrolFactory init()
	{
		try
		{
			VCompoundcontrolFactory theCompoundcontrolFactory = (VCompoundcontrolFactory) EPackage.Registry.INSTANCE
	...
	{
		VCompoundControlImpl compoundControl = new VCompoundControlImpl();
