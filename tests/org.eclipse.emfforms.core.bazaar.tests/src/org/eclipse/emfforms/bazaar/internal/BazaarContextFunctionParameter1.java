 ...
 *
 */
public class BazaarContextFunctionParameter1 implements BazaarContextFunction {
	 ...
	 * @param transformed
	 */
	public BazaarContextFunctionParameter1(Object transformed) {
		this.transformed = transformed;
	}

	@Exchange
	public Object exchange(Integer string) {
		return transformed;
	}
