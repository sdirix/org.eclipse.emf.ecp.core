...
public abstract class AbstractHorizontalTest {
	...
	public static void setHorizontalClass(EClass horizontalClass) {
		AbstractHorizontalTest.horizontalClass = horizontalClass;
