...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.ecp.view.dynamictree.model.TestElementContainer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	IEditingDomainItemProvider, IStructuredItemContentProvider, ITreeItemContentProvider, IItemLabelProvider, IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_TestElementContainer_id_feature", "_UI_TestElementContainer_type"),
				 ModelPackage.Literals.TEST_ELEMENT_CONTAINER__ID,
				 true,
				 false,
				 false,
	...
	public Collection<?> getChildren(Object object) {
		final TestElementContainer elementContainer = (TestElementContainer) object;
		final List<TestElement> children = new ArrayList<TestElement>();
		for (final TestElement child : elementContainer.getTestElements()) {
			if (child.getParentId().equals(elementContainer.getId())) {
				children.add(child);
			}
		}
		return children;
	...
	{
		String label = ((TestElementContainer)object).getId();
