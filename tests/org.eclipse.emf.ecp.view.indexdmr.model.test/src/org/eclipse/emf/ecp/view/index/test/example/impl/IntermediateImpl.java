...
public class IntermediateImpl extends MinimalEObjectImpl.Container implements Intermediate {
	 ...
	 * @ordered
	 */
	protected org.eclipse.emf.ecp.view.index.test.example.Container container;
	 ...
	 */
	@Override
	public org.eclipse.emf.ecp.view.index.test.example.Container getContainer() {
		return container;
	}
	...
	public NotificationChain basicSetContainer(org.eclipse.emf.ecp.view.index.test.example.Container newContainer,
		...
		final org.eclipse.emf.ecp.view.index.test.example.Container oldContainer = container;
	 ...
	 */
	@Override
	public void setContainer(org.eclipse.emf.ecp.view.index.test.example.Container newContainer) {
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case ExamplePackage.INTERMEDIATE__CONTAINER:
			setContainer((org.eclipse.emf.ecp.view.index.test.example.Container) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case ExamplePackage.INTERMEDIATE__CONTAINER:
			setContainer((org.eclipse.emf.ecp.view.index.test.example.Container) null);
			return;
		}
