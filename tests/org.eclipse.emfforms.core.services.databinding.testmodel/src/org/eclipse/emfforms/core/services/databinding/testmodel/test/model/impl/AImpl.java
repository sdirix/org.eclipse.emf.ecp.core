 ...
 * <ul>
 * <li>
 * {@link org.eclipse.emfforms.core.services.databinding.testmodel.test.model.impl.AImpl#getB
 * <em>B</em>}</li>
 * </ul>
 * </p>
 *
...
public class AImpl extends MinimalEObjectImpl.Container implements A {
	/**
	 * The cached value of the '{@link #getB() <em>B</em>}' containment
	...
	public NotificationChain basicSetB(B newB, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			final ENotificationImpl notification = new ENotificationImpl(this,
				Notification.SET, TestPackage.A__B, oldB, newB);
			if (msgs == null) {
				msgs = notification;
			} else {
		...
		if (newB != b) {
			...
			if (b != null) {
				msgs = ((InternalEObject) b).eInverseRemove(this,
					EOPPOSITE_FEATURE_BASE - TestPackage.A__B, null, msgs);
			}
			if (newB != null) {
