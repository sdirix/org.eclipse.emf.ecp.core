 ...
 * @generated
 */
public class ContainerImpl extends MinimalEObjectImpl.Container implements org.eclipse.emf.ecp.view.keyattribute.test.example.Container {
	/**
	...
	public EList<Child> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<Child>(Child.class, this, ExamplePackage.CONTAINER__CHILDREN);
		}
		return children;
	}
