...
public class CourseItemProvider extends ItemProviderAdapter implements
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				...
				UniversityPackage.Literals.COURSE__ID,
				true,
				false,
				false,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			...
			(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				...
				UniversityPackage.Literals.COURSE__NAME,
				true,
				false,
				false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addEtcsPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			...
			(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				...
				UniversityPackage.Literals.COURSE__ETCS,
				true,
				false,
				false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Course")); //$NON-NLS-1$
	}
