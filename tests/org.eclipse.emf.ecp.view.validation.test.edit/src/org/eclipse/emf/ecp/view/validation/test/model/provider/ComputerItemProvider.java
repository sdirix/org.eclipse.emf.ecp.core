...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.ecp.view.validation.test.model.Computer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComputerItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TestPackage.Literals.COMPUTER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TestPackage.Literals.COMPUTER__MAINBOARD);
			childrenFeatures.add(TestPackage.Literals.COMPUTER__POWER_BLOCK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TestPackage.Literals.COMPUTER__MAINBOARD,
				 TestFactory.eINSTANCE.createMainboard()));

		newChildDescriptors.add
			(createChildParameter
				(TestPackage.Literals.COMPUTER__POWER_BLOCK,
				 TestFactory.eINSTANCE.createPowerBlock()));
	}
