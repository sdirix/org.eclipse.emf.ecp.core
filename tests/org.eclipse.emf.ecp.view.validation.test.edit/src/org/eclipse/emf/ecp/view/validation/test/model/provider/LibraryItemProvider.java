...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.ecp.view.validation.test.model.Library} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LibraryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TestPackage.Literals.LIBRARY__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TestPackage.Literals.LIBRARY__WRITERS);
			childrenFeatures.add(TestPackage.Literals.LIBRARY__BOOKS);
			childrenFeatures.add(TestPackage.Literals.LIBRARY__LIBRARIAN);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TestPackage.Literals.LIBRARY__WRITERS,
				 TestFactory.eINSTANCE.createWriter()));

		newChildDescriptors.add
			(createChildParameter
				(TestPackage.Literals.LIBRARY__BOOKS,
				 TestFactory.eINSTANCE.createBook()));

		newChildDescriptors.add
			(createChildParameter
				(TestPackage.Literals.LIBRARY__LIBRARIAN,
				 TestFactory.eINSTANCE.createLibrarian()));
	}
