...
public class TestSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TestPackage.TEST1: {
			final Test1 test1 = (Test1) theEObject;
			T result = caseTest1(test1);
			if (result == null) {
				result = caseBase(test1);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case TestPackage.TEST2: {
			final Test2 test2 = (Test2) theEObject;
			T result = caseTest2(test2);
			if (result == null) {
				result = caseBase(test2);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case TestPackage.TEST3: {
			final Test3 test3 = (Test3) theEObject;
			T result = caseTest3(test3);
			if (result == null) {
				result = caseBase(test3);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case TestPackage.TEST4: {
			final Test4 test4 = (Test4) theEObject;
			T result = caseTest4(test4);
			if (result == null) {
				result = caseBase(test4);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Test3</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Test3</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTest3(Test3 object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Test4</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Test4</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTest4(Test4 object) {
		return null;
	}
