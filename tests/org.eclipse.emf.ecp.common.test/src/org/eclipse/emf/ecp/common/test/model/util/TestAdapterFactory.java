 ...
 */
package org.eclipse.emf.ecp.common.test.model.util;
...
public class TestAdapterFactory extends AdapterFactoryImpl {
	...
	protected TestSwitch<Adapter> modelSwitch = new TestSwitch<Adapter>() {
		...
		@Override
		public Adapter caseTest3(Test3 object) {
			return createTest3Adapter();
		}

		@Override
		public Adapter caseTest4(Test4 object) {
			return createTest4Adapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.common.test.model.Base <em>Base</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.common.test.model.Test1 <em>Test1</em>}
	 * '.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.common.test.model.Test2 <em>Test2</em>}
	 * '.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.common.test.model.Test3 <em>Test3</em>}
	 * '.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 ...
	 * @generated
	 */
	public Adapter createTest3Adapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.common.test.model.Test4 <em>Test4</em>}
	 * '.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 ...
	 * @generated
	 */
	public Adapter createTest4Adapter() {
		return null;
	}
