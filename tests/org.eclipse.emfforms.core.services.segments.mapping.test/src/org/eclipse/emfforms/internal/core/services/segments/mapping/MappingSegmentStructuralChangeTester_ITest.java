...
/**
 * JUnit integration test cases for {@link MappingSegmentStructuralChangeTester}.
 *
 * @author Lucas Koehler
 *
 */
public class MappingSegmentStructuralChangeTester_ITest {
	...
	public static void setUpBeforeClass() {
		bundleContext = FrameworkUtil.getBundle(MappingSegmentStructuralChangeTester_ITest.class).getBundleContext();
	}
	...
	public void testServiceType() {
		assertTrue(MappingSegmentStructuralChangeTester.class.isInstance(service));
	}
	...
	public void testIntegration() throws DatabindingFailedException {
		...
		final VMappingDomainModelReferenceSegment segment = mock(VMappingDomainModelReferenceSegment.class);
		final EObject domain = mock(EObject.class);

		final MappingSegmentStructuralChangeTester changeTester = (MappingSegmentStructuralChangeTester) service;
