 ...
 */
package org.eclipse.emf.ecp.view.mapping.test.example.util;
 ...
 * <!-- end-user-doc -->
 *
 * @see org.eclipse.emf.ecp.view.mapping.test.example.ExamplePackage
 * @generated
 */
public class ExampleAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.view.mapping.test.example.Root
	 * <em>Root</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.view.mapping.test.example.Intermediate
	 * <em>Intermediate</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.view.mapping.test.example.Container
	 * <em>Container</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.view.mapping.test.example.AbstractChild
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.view.mapping.test.example.Child
	 * <em>Child</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 ...
	 * {@link org.eclipse.emf.ecp.view.mapping.test.example.IntermediateTarget <em>Intermediate Target</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.emf.ecp.view.mapping.test.example.Target
	 * <em>Target</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>EClass To Addition Map</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEClassToAdditionMapAdapter() {
		return null;
	}
