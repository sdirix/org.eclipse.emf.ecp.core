...
public class ExampleSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ExamplePackage.ABSTRACT_CHILD: {
			final AbstractChild abstractChild = (AbstractChild) theEObject;
		...
		case ExamplePackage.CHILD: {
			...
			if (result == null) {
				result = caseAbstractChild(child);
			}
			if (result == null) {
				result = defaultCase(theEObject);
			}
		...
		case ExamplePackage.ECLASS_TO_ADDITION_MAP: {
			...
			final Map.Entry<EClass, AbstractChild> eClassToAdditionMap = (Map.Entry<EClass, AbstractChild>) theEObject;
			T result = caseEClassToAdditionMap(eClassToAdditionMap);
			if (result == null) {
				result = defaultCase(theEObject);
			}
			return result;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EClass To Addition Map</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 *
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EClass To Addition Map</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEClassToAdditionMap(Map.Entry<EClass, AbstractChild> object) {
		return null;
	}
