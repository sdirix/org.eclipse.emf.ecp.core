...
public class CarPackageImpl extends EPackageImpl implements CarPackage {
	...
	public static CarPackage init() {
		...
		CarPackageImpl theCarPackage = (CarPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof CarPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new CarPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getDriver_Age(), ecorePackage.getEInt(), "age", null, 0, 1, Driver.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(carEClass, Car.class, "Car", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCar_Manufacturer(), ecorePackage.getEString(), "manufacturer", null, 0, 1, Car.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getCar_SeatCount(), ecorePackage.getEInt(), "seatCount", null, 0, 1, Car.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
