...
public class PersonImpl extends MinimalEObjectImpl.Container implements Person {
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarPackage.PERSON__NAME, oldName, name));
	}
	...
	public EList<Person> getChildren() {
		if (children == null) {
			children = new EObjectContainmentEList<Person>(Person.class, this, CarPackage.PERSON__CHILDREN);
		}
		return children;
	}
	...
	public void setBirthPlace(String newBirthPlace) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CarPackage.PERSON__BIRTH_PLACE, oldBirthPlace, birthPlace));
	}
