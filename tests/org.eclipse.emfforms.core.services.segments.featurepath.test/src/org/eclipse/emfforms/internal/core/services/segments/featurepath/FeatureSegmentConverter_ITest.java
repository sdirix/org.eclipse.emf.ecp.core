...
/**
 * JUnit integration test for the {@link FeatureSegmentConverter}.
 *
 * @author Lucas Koehler
 *
 */
public class FeatureSegmentConverter_ITest {
	...
	public static void setUpBeforeClass() {
		bundleContext = FrameworkUtil.getBundle(FeatureSegmentConverter_ITest.class)
			.getBundleContext();
	}
	...
	public void testServiceType() {
		assertTrue(FeatureSegmentConverter.class.isInstance(service));
