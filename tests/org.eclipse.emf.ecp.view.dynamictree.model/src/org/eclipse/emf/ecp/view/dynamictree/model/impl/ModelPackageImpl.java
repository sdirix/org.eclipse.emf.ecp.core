...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage
{
	...
	public void initializePackageContents()
	{
		...
		initEReference(getDynamicContainmentTree_ChildComposite(), theViewPackage.getContainedElement(), null,
			...
			IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDynamicContainmentTree_Items(), this.getDynamicContainmentItem(), null, "items", null, 0, -1,
		...
		initEReference(getDynamicContainmentItem_DomainModel(), ecorePackage.getEObject(), null, "domainModel", null,
			...
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDynamicContainmentItem_Items(), this.getDynamicContainmentItem(), null, "items", null, 0, -1,
		...
		initEReference(getTestElement_Elements(), this.getTestElement(), null, "elements", null, 0, -1,
		...
		initEClass(domainRootEClass, DomainRoot.class, "DomainRoot", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDomainRoot_Intermediate(), this.getDomainIntermediate(), null, "intermediate", null, 0, 1,
		...
		initEClass(domainIntermediateEClass, DomainIntermediate.class, "DomainIntermediate", !IS_ABSTRACT,
			!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDomainIntermediate_TestElementContainer(), this.getTestElementContainer(), null,
		...
		initEClass(testElementContainerEClass, TestElementContainer.class, "TestElementContainer", !IS_ABSTRACT,
			!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTestElementContainer_TestElements(), this.getTestElement(), null, "testElements", null, 0,
