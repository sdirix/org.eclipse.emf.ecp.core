...
public class DynamicContainmentTreeImpl extends VCategoryImpl implements DynamicContainmentTree
{
	...
	{
		super();
		addNavigatedDependencyToLabelAdapter(ModelPackage.Literals.DYNAMIC_CONTAINMENT_TREE__DOMAIN_MODEL,
			ModelPackage.Literals.TEST_ELEMENT_CONTAINER__ID);
		addLocalDependencyToChildrenAdapter(ModelPackage.Literals.DYNAMIC_CONTAINMENT_TREE__ITEMS);
	}
	...
	public String getLabel() {
		final TestElementContainer element = (TestElementContainer) getDomainModel();
