...
public class ModelValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public boolean validateDynamicContainmentTree(DynamicContainmentTree dynamicContainmentTree, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateDynamicContainmentItem(DynamicContainmentItem dynamicContainmentItem, DiagnosticChain diagnostics, Map<Object, Object> context) {
	...
	public boolean validateTestElement(TestElement testElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(testElement, diagnostics, context)) return false;
		boolean result = validate_EveryMultiplicityConforms(testElement, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryDataValueConforms(testElement, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryReferenceIsContained(testElement, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryBidirectionalReferenceIsPaired(testElement, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryProxyResolves(testElement, diagnostics, context);
		if (result || diagnostics != null) result &= validate_UniqueID(testElement, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryKeyUnique(testElement, diagnostics, context);
		if (result || diagnostics != null) result &= validate_EveryMapEntryUnique(testElement, diagnostics, context);
		if (result || diagnostics != null) result &= validateTestElement_validate(testElement, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateTestElement_validate(TestElement testElement, DiagnosticChain diagnostics, Map<Object, Object> context) {
	 ...
	 * @generated
	 */
	public boolean validateDomainIntermediate(DomainIntermediate domainIntermediate, DiagnosticChain diagnostics, Map<Object, Object> context) {
